/**
 * PongGame - A class which holds the main game loop/clock and thread. This is the body of the 'game engine'.  
 */
package Pong;
...
public class PongGame implements Runnable {
	 ...
	 */
	public PongGame(String title, int width, int height) {
